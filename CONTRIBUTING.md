...
If you want to contribute then looking at the document ["Tatin for contributors"](https://aplteam.github.io/Tatin/contribute/ "Link to Tatin For Contributors in the Tatin documentation") is a must.
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/aplteam/Tatin/issues/?q=label%3Abug "Link to list with all Tatin bugs, including (!) closed ones"). An AI can greatly help with that.
...
> You must never report security-related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <kai@aplteam.com>, preferably encrypted.

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

* Open an [Issue](https://github.com/aplteam/Tatin/issues/new "This link creates a new Tatin issue"). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- You may want to include screenshots and animated GIFs which help you demonstrate the steps or point out the part to which the suggestion is related. You can use [LICEcap](https://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and [Silentcast](https://github.com/colinkeenan/silentcast) on Linux.
...
This guide is based on [contributing.md](https://contributing.md/ "Link to contributing.md, the source this guide is based on").
